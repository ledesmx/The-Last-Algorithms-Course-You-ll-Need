...
test("[-15, 500, 1000, 123, -135, 1345, -556, -3, 145, 0, 4, 777] - 777 -> true", () => {
    expect(linear_search([-15, 500, 1000, 123, -135, 1345, -556, -3, 145, 0, 4, 777], 777)).toBe(true);
});

test("[-15, 500, 1000, 123, -135, 1345, -556, -3, 145, 0, 4, 777] - 999 -> false", () => {
    expect(linear_search([-15, 500, 1000, 123, -135, 1345, -556, -3, 145, 0, 4, 777], 999)).toBe(false);
});
