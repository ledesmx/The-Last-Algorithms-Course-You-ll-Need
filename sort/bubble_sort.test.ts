...
test("[9, -2, 4, -1, 0, -5, -9, 5, 1, 2, -4]", () => {
  ...
  bubble_sort(list);
  expect(list).toEqual([-9, -5, -4, -2, -1, 0, 1, 2, 4, 5, 9]);
});
...
test("[99, 11]", () => {
  let list = [99, 11];
  bubble_sort(list);
  expect(list).toEqual([11, 99]);
});

test("[2000, 12, -666, 123, -999, 1500, -1999, -24]", () => {
  let list = [2000, 12, -666, 123, -999, 1500, -1999, -24];
  bubble_sort(list);
  expect(list).toEqual([-1999, -999, -666, -24, 12, 123, 1500, 2000]);
});

test("[-100000, 0, 900, 10001, -99999, 1, 901, 10002, -99998, 2, 902, 10003, -99997, 3, 903, 10004, -99996, 4, 904, 10005]", () => {
  let list = [
    -100000, 0, 900, 10001, -99999, 1, 901, 10002, -99998, 2, 902, 10003,
    -99997, 3, 903, 10004, -99996, 4, 904, 10005,
  ];
  bubble_sort(list);
  expect(list).toEqual([
    -100000, -99999, -99998, -99997, -99996, 0, 1, 2, 3, 4, 900, 901, 902, 903,
    904, 10001, 10002, 10003, 10004, 10005,
  ]);
});
